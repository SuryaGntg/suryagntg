...
def login():
    ...
    print ('\033[34;1m|            |')
    print ('\033[34;1m|  MR.PPG  |')
    print ('\033[34;1m|____________|')
    print (' ')
    print ('\033[34;1mMR.PPG APA PASSWORD NY?')
    print ('       ')
...
print ("\033[36;1m█▄█████▄█")
print ("\033[33;1m█▼▼▼▼▼")
print ("\033[32;1m█\033[32;1mAuthor : MR.PPG BLACK-404/F")
print ("\033[32;1m█\033[32;1mYt     : PPG, dan BLACK SQUAD")
print ("\033[33;1m█▲▲▲▲▲")
print ("\033[36;1m█████████")
print ("\033[36;1m██ ██")
print ('  ')
